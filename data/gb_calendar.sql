...
-- -----------------------------------------------------
-- Table `gb_calendar`.`clndr_user`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gb_calendar`.`clndr_user` ;
...
-- -----------------------------------------------------
-- Table `gb_calendar`.`clndr_calendar`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gb_calendar`.`clndr_calendar` ;
...
-- -----------------------------------------------------
-- Table `gb_calendar`.`clndr_access`
-- -----------------------------------------------------
DROP TABLE IF EXISTS `gb_calendar`.`clndr_access` ;
